...
public class FloatViewWindowManager {
	...
	public static void updateUsedPercent(String stamp, boolean enable) {
		if (smallWindow != null) {
			TextView percentView = (TextView) smallWindow
					.findViewById(R.id.percent);
			LinearLayout linearLayout = smallWindow.findViewById(R.id.small_window_layout);
			linearLayout.setVisibility(View.VISIBLE);
			if (enable){
				linearLayout.setOnClickListener(v -> {
					removeSmallWindow(percentView.getContext());
				});
			}
			percentView.setText(stamp);
		}
	}
