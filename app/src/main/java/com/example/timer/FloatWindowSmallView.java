...
public class FloatWindowSmallView extends LinearLayout {
	...
	public FloatWindowSmallView(Context context) {
		...
		percentView.setText("00:00:00");
		smallWindowLayout.setVisibility(GONE);
	}
...
//		FloatViewWindowManager.createBigWindow(getContext());
		FloatViewWindowManager.removeSmallWindow(getContext());
	}
